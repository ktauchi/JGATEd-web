...
@Service public class DA24Service{
	private static final Logger logger = LoggerFactory.getLogger(DA24Service.class);
	...
	*/
	...
	public void parse(Exchange exchange, @Headers Map<String, Object> headers, @Body Map<String, String> body){
		...
		logger.debug("sbuject: {}, body: {}", subject, body);
